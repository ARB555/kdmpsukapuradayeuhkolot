  ...
  <footer class="main-footer">
    ...
    <a href=""><strong>Copyright &copy; 2025</strong> - DKKGM - Sistem Informasi Laporan Keuangan</a>
  </footer>
    ...
    function updateDashboard() {
      $.ajax({
        ...
        success: function(data) {
          $('#pemasukan-hari-value').text('Rp. ' + new Intl.NumberFormat('id-ID').format(data.pemasukan_hari) + ' ,-');
          $('#pemasukan-bulan-value').text('Rp. ' + new Intl.NumberFormat('id-ID').format(data.pemasukan_bulan) + ' ,-');
          $('#pemasukan-tahun-value').text('Rp. ' + new Intl.NumberFormat('id-ID').format(data.pemasukan_tahun) + ' ,-');
          $('#pemasukan-total-value').text('Rp. ' + new Intl.NumberFormat('id-ID').format(data.pemasukan_total) + ' ,-');
          $('#pengeluaran-hari-value').text('Rp. ' + new Intl.NumberFormat('id-ID').format(data.pengeluaran_hari) + ' ,-');
          $('#pengeluaran-bulan-value').text('Rp. ' + new Intl.NumberFormat('id-ID').format(data.pengeluaran_bulan) + ' ,-');
          $('#pengeluaran-tahun-value').text('Rp. ' + new Intl.NumberFormat('id-ID').format(data.pengeluaran_tahun) + ' ,-');
          $('#pengeluaran-total-value').text('Rp. ' + new Intl.NumberFormat('id-ID').format(data.pengeluaran_total) + ' ,-');
        },
