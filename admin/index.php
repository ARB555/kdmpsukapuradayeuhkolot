  ...
  <section class="content">
    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-green" id="pemasukan-hari">
          <div class="inner">
            <?php
            $tanggal = date('Y-m-d');
            ...
            ?>
            <h4 style="font-weight: bolder" id="pemasukan-hari-value"><?= "Rp. " . number_format($p['total_pemasukan']) . " ,-" ?></h4>
      ...
      <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-blue" id="pemasukan-bulan">
          <div class="inner">
            <?php
            $bulan = date('m');
            ...
            $p = mysqli_fetch_assoc($pemasukan);
            ?>
            <h4 style="font-weight: bolder" id="pemasukan-bulan-value"><?= "Rp. " . number_format($p['total_pemasukan']) . " ,-" ?></h4>
      ...
      <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-orange" id="pemasukan-tahun">
          <div class="inner">
            <?php
            $tahun = date('Y');
            ...
            $p = mysqli_fetch_assoc($pemasukan);
            ?>
            <h4 style="font-weight: bolder" id="pemasukan-tahun-value"><?= "Rp. " . number_format($p['total_pemasukan']) . " ,-" ?></h4>
      ...
      <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-black" id="pemasukan-total">
          <div class="inner">
            <?php
            ...
            $p = mysqli_fetch_assoc($pemasukan);
            ?>
            <h4 style="font-weight: bolder" id="pemasukan-total-value"><?= "Rp. " . number_format($p['total_pemasukan']) . " ,-" ?></h4>
      ...
      <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-red" id="pengeluaran-hari">
          <div class="inner">
            <?php
            $tanggal = date('Y-m-d');
            ...
            <h4 style="font-weight: bolder" id="pengeluaran-hari-value"><?= "Rp. " . number_format($p['total_pengeluaran']) . " ,-" ?></h4>
      ...
      <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-red" id="pengeluaran-bulan">
          <div class="inner">
            <?php
            $bulan = date('m');
            ...
            <h4 style="font-weight: bolder" id="pengeluaran-bulan-value"><?= "Rp. " . number_format($p['total_pengeluaran']) . " ,-" ?></h4>
      ...
      <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-red" id="pengeluaran-tahun">
          <div class="inner">
            <?php
            $tahun = date('Y');
            ...
            <h4 style="font-weight: bolder" id="pengeluaran-tahun-value"><?= "Rp. " . number_format($p['total_pengeluaran']) . " ,-" ?></h4>
      ...
      <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-black" id="pengeluaran-total">
          <div class="inner">
            <?php
            ...
            $p = mysqli_fetch_assoc($pengeluaran);
            ?>
            <h4 style="font-weight: bolder" id="pengeluaran-total-value"><?= "Rp. " . number_format($p['total_pengeluaran']) . " ,-" ?></h4>
